...
<div style="width: 20%;border-radius:6px; background-color:#222121;display:flex;flex-direction:column;"><p style="color: #ebb572;margin-left: -100px;">Страна Производитель:</p>
    <div style="display:flex;flex-direction:column">
        ...
        <input type="radio" id="contactChoice2"
               name="contact" style="margin-left: -180px">
        <label for="contactChoice2"style="color: #ebb572; margin-left: 70px;margin-top: -16px;margin-bottom: 20px">Сша</label>
...
<div style="height:100%;width: 75%;border-radius:6px; display:flex;flex-direction:column;">
<div style="height: 100%;width: 100%;border-radius:6px;display:flex;flex-direction: row;flex-wrap: wrap;height:fit-content">
    ...
    for($i=1; $i<=100; $i++){echo(
        "<div class=\"menu_izdeliya\"><img src=\"https://prostokvashino.ru/upload/iblock/d28/d28e1b22ab38bfcce66f54a1a80e7526.jpg\"width=301px height=201px style=\"border-radius: 10px;\"><button style=\"border-radius: 7px;margin-left: 240px;margin-top: -50px;cursor: pointer;background: transparent;\"><img src=\"https://cdn-icons-png.flaticon.com/512/1374/1374128.png\" width=\"40\" ></button>        <div style=\"border: 2px solid black;border-radius: 5px;border-style: dotted\">            <p class = \"menu_text\"> Сырники с клюквенным вареньем и сметаной</p>   <div style=\"display: flex; flex-direction: row;justify-content: space-between;\">            <p class = \"price\"> 300 руб. </p>            <p class = \"price\"> 300 гр </p>         </div>        </div></div>"
    );};
    ?>    
